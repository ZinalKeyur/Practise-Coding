...
Stdout
LRUCache { cache: Map(0) {}, capacity: 2 }
this.cache.has(1) before put function : false
this.cache.has(1) after put function set value : true
LRUCache { cache: Map(1) { 1 => 1 }, capacity: 2 }
this.cache.keys().next().value : 1
LRUCache { cache: Map(1) { 1 => 1 }, capacity: 2 }
this.cache.has(2) before put function : false
this.cache.has(2) after put function set value : true
LRUCache { cache: Map(2) { 1 => 1, 2 => 2 }, capacity: 2 }
this.cache.keys().next().value : 1
LRUCache { cache: Map(2) { 1 => 1, 2 => 2 }, capacity: 2 }
this.cache.has(1) before get function : true
this.cache.has(1) after get function = : true
LRUCache { cache: Map(2) { 2 => 2, 1 => 1 }, capacity: 2 }            // KEY MOVED AHEAD IN MAP SINCE IT WAS CALLED.
this.cache.has(3) before put function : false
this.cache.has(3) after put function set value : true
LRUCache { cache: Map(3) { 2 => 2, 1 => 1, 3 => 3 }, capacity: 2 }
this.cache.keys().next().value : 2
LRUCache { cache: Map(3) { 2 => 2, 1 => 1, 3 => 3 }, capacity: 2 }
Cache capacity exceeded so deleting this.cache.keys().next().value
LRUCache { cache: Map(2) { 1 => 1, 3 => 3 }, capacity: 2 }
this.cache.has(2) before get function : false
this.cache.has(4) before put function : false
this.cache.has(4) after put function set value : true
LRUCache { cache: Map(3) { 1 => 1, 3 => 3, 4 => 4 }, capacity: 2 }
this.cache.keys().next().value : 1
LRUCache { cache: Map(3) { 1 => 1, 3 => 3, 4 => 4 }, capacity: 2 }
Cache capacity exceeded so deleting this.cache.keys().next().value
LRUCache { cache: Map(2) { 3 => 3, 4 => 4 }, capacity: 2 }
this.cache.has(1) before get function : false
this.cache.has(3) before get function : true
this.cache.has(3) after get function = : true
LRUCache { cache: Map(2) { 4 => 4, 3 => 3 }, capacity: 2 }
this.cache.has(4) before get function : true
this.cache.has(4) after get function = : true
LRUCache { cache: Map(2) { 3 => 3, 4 => 4 }, capacity: 2 }
View less
Output
[null,null,null,1,null,-1,null,-1,3,4]
